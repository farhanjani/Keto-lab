<template>
  <div class="checkout-type2">
    <div class="app">
      <header>
        <div class="product-logo"><img :src="`${PRODUCT_IMG_URL}/${product.logo}`" :alt="`${product.name}`" width="100px"></div>
      </header>
      <div class="content">
        <section class="container order-form-container">
          <div class="product-image-and-reviews">
            <div class="product-images single-image">
              <div class="product-images__main-image"><img :src="`${PRODUCT_IMG_URL}/${product.image}`"></div>
            </div>
            <div class="reviews-container">
              <div class="active-viewers-block mobile-viewers"><strong>121 People </strong> are viewing this item</div>
              <div class="comments-and-navigation">
                <h2 class="total">{{ product_reviews.length }} Comments</h2>
                <div class="active-viewers-block"><strong>121 People </strong> are viewing this item</div>
                <div class="reviews-navigation swiper-navigation ">
              ...
              <div class="reviews">
                <!-- Review Start -->
                <div class="review" v-for="product_review in product_reviews" :key="product_review.id">
                  <div class="left">
                    <img :src="`${CUSTOMER_IMG_URL}/${product_review.customer_photo}`" alt="product_review.customer_name" class="review__image">
                    <!-- <div class="review__image" style="background-image: url(/images/jordan.jpg);"></div> -->
                    <div class="top mobile-texts">
                      <h2 class="review__name">{{ product_review.customer_name }}</h2> <span class="review__location">{{ product_review.customer_country }}</span>
                    </div>
                  </div>
                  <div class="reviews__texts">
                    ...
                    <div class="review__text"> {{ product_review.customer_review }}</div>
                    <div class="review__date"> {{ product_review.purchase_date }} </div>
                  </div>
                </div>
                <!-- Review End -->
                <!-- <div class="review">
                  <div class="left">
                    <div class="review__image" style="background-image: url(/images/vera.jpg);"></div>
                    <div class="top mobile-texts">
                      <h2 class="review__name">Vera O.</h2> <span class="review__location">Pakistan</span>
                    </div>
                  </div>
                  <div class="reviews__texts">
                    <div class="top">
                    ...
                    <div class="review__text"> So glad I purchased one, it didn’t take long to arrive but since I’ve had
                      it I have to say it is my most used gadget. Unbelievable considering the price. I use mine
                      everyday and life wouldn’t be the same without
                      it now. The instructions are super easy to follow which is good because I’d never used one before.
                    </div>
                    <div class="review__date"> December 19, 2022 17:17 PM </div>
                  </div>
                </div>
                <div class="review">
                  <div class="left">
                    <div class="review__image" style="background-image: url(/images/mary.jpg);"></div>
                    <div class="top mobile-texts">
                      <h2 class="review__name">Marry S.</h2> <span class="review__location">Pakistan</span>
                    </div>
                  </div>
                  <div class="reviews__texts">
                    <div class="top">
                    ...
                    <div class="review__text"> Not the sort of thing I would usually purchase but glad I did. Now that I
                      have it, everyone wants to know where I got mine from. </div>
                    <div class="review__date"> December 19, 2022 17:17 PM </div>
                  </div>
                </div> -->
              </div>
          ...
          <div class="discount-panel">
            <p class="discount-panel__text">Your <span class="discount-panel__text--highlighted">50% discount</span> has
              been applied!</p>
          </div>
          <form @submit.prevent="onSubmit" id="order-form" class="payment_form">
            <div class="payment-steps">
              <div class="payment-steps__left-col">
                <section class="scroll-to-block">
                  <div class="step"><span class="step__number">Step 1:</span> <span class="step__title">Choose Your
                      Offer</span></div>
                  <div class="quantity-chooser no-installment">
                    <div class="products" v-if="hasInitialized">
                      <div v-for="(offer, index) in product.offers" :key="offer.id"
                        :class="`product bestseller border ${activeOffer == index ? 'active1' : ''}`">
                        <div class="product__top radio"
                          @click="doActiveOffer(index, (offer.price * offer.discount / 100).toFixed(2), offer.crm_id, offer.campaign_id)">
                          <div class="product__left radio--selected">
                            <p class="product__name">
                              {{ offer.title }}
                            </p>
                            <p class="product__discount">
                              <span>{{ offer.discount }}% Discount</span>
                              <span><span>$ {{ (product.price - (product.price * offer.discount / 100)).toFixed(2)
                              }}</span> / each </span>
                            </p>
                          </div>
                          <div class="product__right">
                            <span>
                              <span class="product__price">$ {{ (offer.price * offer.discount / 100).toFixed(2) }}</span>
                              <span class="product__price product__price--old">$ {{ offer.price }}</span>
                            </span>
                          </div>
                        </div>
                        <!-- <p class="product__bestseller"><strong>34 Bought Today</strong></p> -->
                        <p v-if="index == 0" class="product__recommended"><strong>Recommended Deal</strong></p>
                      </div>
                    </div>
                  </div>
                  <div class="warranty warranty__no-installment">
                    <div class="warranty__label">
                      <input v-model="tookWarranty" type="checkbox" id="warrantee-input" class="warrantee"
                        autocomplete="none">
                      <div class="warranty__left">
                        <span class="warranty__line warranty__line--product-name">Frequently Bought With</span>
                        <span class="bottom">
                          <span class="bottom-texts">
                            <span class="warranty__line">3 Years Warranty</span>
                            <span class="product__price">
                              $ {{warrantyPrice}}
                            </span>
                            <span></span>
                          </span>
                          <span class="great-deal-text">Great Deal</span>
                        </span>
                      </div>
                      <div class="warranty__right"><span><span class="product__price">$ 2,044</span></span>
                        <!---->
                      </div>
                    </div>
                  </div>
              ...
              <section class="scroll-to-block">
                <div class="payment-types-container">
                  <div class="step"><span class="step__number">Step 2:</span> <span class="step__title">Payment
                      Method</span></div>
                  <div class="payment-methods">
                    <div class="payment-method payment-method--selected CC-payment">
                      <div class="radio radio--selected cc--selected">
                  ...
                  <section class="scroll-to-block">
                    <div class="step"><span class="step__number">Step 3:</span> <span class="step__title">Contact
                        Information</span></div>
                    <div class="form-group__two-col">
                      <div class="form-field">
                        <input v-model.trim="$v.firstName.$model" placeholder="First Name" field="input" type="text"
                          maxlength="50" autocomplete="none" class="form-control form-field__input"
                    ...
                    <div class="form-group">
                      <div class="form-field form-field--full">
                        <input v-model.trim="$v.email.$model" placeholder="Email Address" autocomplete="none" field="input" type="text"
                          class="form-control form-field__input" :class="{ 'is-invalid': $v.email.$error }">
                      ...
                      <div class="form-field form-field--full">
                        <div class="form-input phone-is-empty" name="phone">
                          <div class="iti iti--allow-dropdown">
                            ...
                            <input v-model.trim="$v.phone.$model" type="tel" autocomplete="none" class="form-control intl-tel-input form-field__input"
                  ...
                  <section class="scroll-to-block">
                    <div class="step"><span class="step__number">Step 4:</span> <span class="step__title">Shipping
                        Details</span></div>
                    <div class="form-group">
                      <div class="form-field">
                        <div>
                          <div class="cs-container cs-container--value-set">
                            <select style="padding: 10px;" class="form-select" aria-label="Default select example" v-model.trim="$v.country.$model" :class="{ 'is-invalid': $v.country.$error }">
                      ...
                      <div class="form-field">
                        <input v-model.trim="$v.city.$model" placeholder="Town/City" autocomplete="none" field="input" type="text"
                          maxlength="50" class="form-control form-field__input" :class="{ 'is-invalid': $v.city.$error }">
                      ...
                      <div class="form-field form-field--full">
                        <input v-model.trim="$v.address.$model" placeholder="Street and House Number" autocomplete="none" field="input"
                          name="address" maxlength="100" class="form-control form-field__input" :class="{ 'is-invalid': $v.address.$error }">
                        <label class="form-field__label">Street and House Number</label>
                      </div>
                      <div class="dependency-field"></div>
                      <div class="form-field form-field--full">
                        <input v-model.trim="$v.zipcode.$model" placeholder="Postal Code" autocomplete="none" field="input" type="text"
                          maxlength="20" class="form-control form-field__input" :class="{ 'is-invalid': $v.zipcode.$error }">
                        <label class="form-field__label">Postal Code</label>
                      </div>
                    </div>
                  </section>
                  <section class="scroll-to-block">
                    <div class="step"><span class="step__number">Step 5:</span> <span class="step__title">Payment
                        Details</span></div>
                    <div>
                      <div class="form-group">
                        <div class="form-field form-field--full" autocomplete="none"><span
                          ...
                          <input v-model.trim="$v.cardNumber.$model" type="number" @input="truncateCardNumber" placeholder="Card Number"
                            class="cc-number form-control form-field__input unknown" :class="{ 'is-invalid': $v.cardNumber.$error }">
                      ...
                      <div class="form-group__two-col-card ">
                        ...
                        <div class="form-field" autocomplete="none">
                          <input v-model.trim="$v.cardCvv.$model" type="number" @input="truncateCVV" placeholder="CVV" class="cc-cvv form-control form-field__input" :class="{ 'is-invalid': $v.cardCvv.$error }">
                          <label class="form-field__label">CVV</label>
                        </div>
                      </div>
                    </div>
                  </section>
                  <button type="submit" class="btn btn--submit btn--primary form-submit-btn"> Complete checkout
                  </button>
                  <div class="descriptor">{{ info_text }}</div>
                  <div class="divider-type-2"><span>GUARANTEED SAFE CHECKOUT</span></div>
                  <ul class="security-icons">
                    <li><img src="/images/mcafee.png"></li>
                    <li><img src="/images/norton.png"></li>
                    <li><img src="/images/es.png"></li>
                  </ul>
                </div>
                <div class="warranty-note">
                  <div class="warranty-note__left"><img src="/images/guarantee.png" alt="">
                    <h2>30 Day Guarantee</h2>
                  </div>
                  <div class="warranty-note__texts">
                    <h2>30 Day Guarantee</h2>
                    <p>If you are not completely thrilled - we are offering you
                      a 30 day guarantee on all purchases. Simply send the item(s) back to us for a full refund or
      ...
      <footer cclass="site-footer">
        <div class="container footer-inner">
          <div class="footer-menu-place">
            <a href="#" class="logo router-link-active"><img src="/images/protected.png"
                alt="logo"></a>
            <ul class="ul_footer">
              <li><a href="#" target="_blank">Home</a></li>
              <li><a href="#" class="" target="_blank">Contact Us</a></li>
              <li><a href="#" class="" target="_blank">Terms &amp; conditions</a>
              </li>
              <li><a href="#" class="" target="_blank">Privacy Policy</a></li>
              <li><a href="#" target="_blank">Affiliate Program</a></li>
            </ul>
          </div>
          <div class="copyright">Copyright © {{ new Date().getFullYear() }} onlybestgadgets. All Rights Reserved</div>
        </div>
      </footer>
...
import { BASE_URL, PRODUCT_IMG_URL, CUSTOMER_IMG_URL } from '../constant'
import {
  required
    ...
    async init() {
      await axios
        ...
        .then((response) => {
          ...
          this.product_reviews = data.product_reviews
          this.product = data
